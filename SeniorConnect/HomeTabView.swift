        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        Text("Device Location: 121 Inverness Drive")
                            .font(.headline)
                            .fontWeight(.semibold)
...
let alertsData: [AlertModel] = [
    ...
    AlertModel(iconName: "message.fill", iconColor: .blue, iconBackgroundColor: Color.blue.opacity(0.2), title: "Message from Grandma", timestamp: "5 hours ago"),
]

struct LocationMap: View {
    @State private var region = MKCoordinateRegion(
        center: CLLocationCoordinate2D(latitude: 39.99430132691132, longitude: -74.89320732335467),
