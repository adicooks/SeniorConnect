...
let Dailyclicks: [(day: Date, clicks: Int)] = [
    (day: date(year: 2023, month: 10, day: 16), clicks: 3),
    (day: date(year: 2023, month: 10, day: 17), clicks: 6),
    (day: date(year: 2023, month: 10, day: 18), clicks: 4),
    (day: date(year: 2023, month: 10, day: 19), clicks: 8),
    (day: date(year: 2023, month: 10, day: 20), clicks: 9),
    (day: date(year: 2023, month: 10, day: 21), clicks: 5),
    (day: date(year: 2023, month: 10, day: 22), clicks: 7)
]
...
struct WeeklyGraphView: View {
    ...
    struct WeeklyClickData {
        var name: String // Date in the format "yyyy-MM-dd"
        var customXAxisName: String // Custom x-axis name
        var clicks: Int
    }
    ...
    let Weeklyclicks: [WeeklyClickData] = [
        WeeklyClickData(name: "2023-10-1", customXAxisName: "Week 1", clicks: 18),
        WeeklyClickData(name: "2023-10-8", customXAxisName: "Week 2", clicks: 24),
        WeeklyClickData(name: "2023-10-15", customXAxisName: "Week 3", clicks: 28),
        WeeklyClickData(name: "2023-10-22", customXAxisName: "Week 4", clicks: 22),
        WeeklyClickData(name: "2023-10-29", customXAxisName: "Week 4", clicks: 35)
    ]
...
struct MonthlyGraphView: View {
    ...
    let Monthlyclicks: [(day: Date, clicks: Int)] = [
        (day: date(year: 2023, month: 6), clicks: 94),
        (day: date(year: 2023, month: 7), clicks: 116),
        (day: date(year: 2023, month: 8), clicks: 109),
        (day: date(year: 2023, month: 9), clicks: 121),
        (day: date(year: 2023, month: 10), clicks: 101)
    ]
}
